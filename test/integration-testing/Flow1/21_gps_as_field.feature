@1.0
Feature: Halspan - Admin - Create a Questionnaire using GPS as a Field
    As  an Admin, I want an option to create the questionnaire by using GPS
  ...
  Scenario: Admin views all types of field and adds  field from the add field section
    ...
    * I should see an add field section
    ...
    And I should see the gps field added to the section 1 page 1 question 1
  ...
  Scenario: Admin adds the label, help text content
    ...
    When I click the gps button
    Then I should see field settings
    When I enter the label name for gps
    Then I should see the label name for gps updated in the section 1
    When I enter the help text for gps
    Then I should see the help text for gps updated in the section 1
