...
When('I select the questionnaire list', async function () {
    ...
    let cook = await driver.wait(until.elementLocated(By.css(`[data-testid="service-record-0"]`))).getText();
    console.log('Questionnaire Name = ', cook);
