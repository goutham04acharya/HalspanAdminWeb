        ...
        <div className='overflow-auto default-sidebar h-customh11'>
            <div className='flex flex-col w-full'>
                <div className='sticky top-0 bg-white z-[99]'>
                    <div className='flex w-full z-[99]'>
                    ...
                    : <div className='bg-white'>
                        {versionList?.data?.items.map((versionListInfo, index) => (
                            <React.Fragment key={index}>
                                <div className='rounded-[10px] mt-[18px] flex w-full relative' ref={dropdownRef}>
                                    ...
                                    <div className='py-6 text-start truncate min-w-[300px] bg-[#F4F6FA] px-10 rounded-tr-[10px] rounded-br-[10px] font-normal text-base text-[#2B333B]' onClick={() => handleDropdownClick(versionListInfo?.version_number)}>
