                                    ...
                                    {complianceLogic.length !== 0 && (
                                        ...
                                        >
                                            <div className="flex items-center justify-between">
                                                ...
                                                >
                                                    <img
                                                        src={`${result?.STATUS === "PASS" ? "/Images/compliant.svg" : "/Images/non-compliant.svg"}`}
                                                        width={12}
                                                        data-testid={
                                                            result?.STATUS === "PASS"
                                                                ? "compliant"
                        ...
                        <div>
                            ...
                            <div className="w-[305px] relative bg-gray-200 mx-auto rounded-full h-2.5 ">
                                <div
                                    ...
                                    style={{
                                        width: `${(((previewNavigation.current_page - 1) / allPages.length) * 100).toFixed(0)}%`,
                                    }}
                                ></div>
                                    ...
                                    (list, index) => {
                                        ...
                                        if (list?.conditional_logic) {
                                            if (list?.conditional_logic?.includes("new Date(")) {
                                                ...
                                                list?.conditional_logic?.includes("getMonth(")
                                            ) {
                                                ...
                                                list?.conditional_logic?.includes("getDay()")
                                            ) {
                                                const daysMap = {
                                                    Sunday: 0,
                                                    Monday: 1,
