...
const TextBoxField = ({
    ...
    const handleInputChange = (e) => {
        ...
        if (
            format === "Alpha" &&
            /[^a-zA-Z ]+|^(Backspace|Tab|Enter|Shift|Control|Alt|ArrowLeft|ArrowRight|ArrowUp|ArrowDown|CapsLock|\s)$/.test(
                newValue,
            )
        ) {
            ...
            format === "Custom Regular Expression" &&
            !new RegExp(regex).test(newValue)
        ) {
    ...
    return (
        <div className="">
            ...
            {question?.question_id &&
                validationErrors?.preview_textboxfield &&
                validationErrors.preview_textboxfield[question.question_id] && (
                    <ErrorMessage
                        error={validationErrors.preview_textboxfield[question.question_id]}
                    />
                )}
