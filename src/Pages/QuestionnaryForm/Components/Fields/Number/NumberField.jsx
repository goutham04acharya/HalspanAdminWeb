    ...
    return (
        <div>
            ...
            {(!preview && fieldSettingParameters?.source === "entryfield") ||
                ...
                <div
                    className={`flex border ${validationErrors?.preview_numberfield?.[question.question_id] ? "border-[#FFA318]" : "border-[#AEB3B7]"} rounded-lg items-center`}
                >
