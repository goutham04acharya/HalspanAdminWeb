                            ...
                            {sections?.map((sectionData, sectionIndex) => (
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        className='mx-1 flex items-center justify-center w-full rounded-[10px] py-7 mt-6 bg-white font-semibold text-[#2B333B] text-base hover:border hover:border-[#2B333B]'>
                                        +
