...
//                 text-[#2B333B] text-[12px] font-bold px-3 disabled:text-[#9FACB9] disabled:border-[#9FACB9] w-[143px]'
//                     onClick={() => handlePrevPage()}
//                 >
//                     <div className='pr-3 h-full flex items-center'>
//                         <img
//                             src={isHoveredPrev  && nextPage ? '/Images/arrow-left.svg' :
//                                 (prevPageExist ? '/Images/arrow-left.svg' : '/Images/disable-arrow-left.svg')}
//                             alt='icon'
//                         />
//                     </div>
//                     Previous
...
//                                 (nextPage ? '/Images/arrow-right.svg' : '/Images/disable-arrow-right.svg')}
//                             alt='icon'
//                         />
//                     </div>
//                 </button>
  ...
  return (
    <div className='flex justify-between items-center px-10 fixed bottom-[40px] left-0 w-full py-3'>
      <div>
        <button type='button' disabled={loading || (!prevPageExist && currentPage === 1)}
          data-testid="previous"
          className='flex items-center border border-[#2B333B] h-10 justify-center hover:text-[#2B333B] rounded text-[#2B333B] text-[12px] font-bold px-3 disabled:text-[#9FACB9] disabled:border-[#9FACB9] w-[143px]'
          onClick={handlePrevPage}
        ...
        >
          <div className='pr-3 h-full flex items-center'>
            <img
              src={isHoveredPrev ? '/Images/arrow-left.svg' : (prevPageExist ? '/Images/arrow-left.svg' : '/Images/disable-arrow-left.svg')}
              alt='icon'
            />
          </div>
          Previous
      ...
      <div>
        ...
        >
          ...
          <div className='pl-3 h-full flex items-center'>
            <img
              src={isHoveredNext ? '/Images/arrow-right.svg' : (nextPage ? '/Images/arrow-right.svg' : '/Images/disable-arrow-right.svg')}
              alt='icon'
            />
          </div>
        </button>
